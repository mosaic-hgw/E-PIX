...
public class SourceDAOImpl extends SourceDAO {

	public SourceDAOImpl() {
	}

	@Override
	public Source getSourceByValue(String value) throws MPIException {
		if (value == null || value.isEmpty()) {
			throw new IllegalArgumentException("Value must not be null.");
		}
		try {
			Source source = (Source) em.createNamedQuery("Source.getSourceByValue").setParameter("value", value)
					.getSingleResult();
			return source;
