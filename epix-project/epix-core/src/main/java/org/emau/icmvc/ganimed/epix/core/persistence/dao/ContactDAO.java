 ...
 * @since 04.11.2010
 */
public abstract class ContactDAO extends GenericDAO {

	public ContactDAO() {}
	
	public abstract Contact addContact(Contact contact) throws MPIException; 

	public abstract void updateContacts(Person findPerson, Person updatePerson);
}
