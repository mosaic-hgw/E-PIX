...
public class MatchingToDatabaseTest {
...
//		context.setContactPreprocessedDAO(contactPreprocessedDAO);
		...
		p.setBirthDate(new Date(43, 9, 28));
	
//		Contact contact1 = new Contact();
//		contact1.setCity("Greifswald");
//		contact1.setStreet("Franz-Mehring-Str. 24");
//		contact1.setZipCode("17489");
//		
//		p.getContacts().add(contact1);
//		
...
//		contact2.setCity("Stralsund");
//		contact2.setStreet("Greifswalder Str. 9");
//		contact2.setZipCode("18435");	
//		
//		p.getContacts().add(contact2);
		...
		iDomain.setOid("1.2.276.0.76.3.1.132.1.1.1.3.2.2.11.7");
		
		Identifier ident1 = new Identifier();
		ident1.setValue("0000937093");
...
//		p.getIdentifiers().add(ident1);
		...
		try {
			...
			MPIResponse res = epixService.requestMPINoPersist(request);
