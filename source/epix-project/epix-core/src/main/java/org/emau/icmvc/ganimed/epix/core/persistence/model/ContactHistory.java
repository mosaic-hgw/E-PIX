...
public class ContactHistory extends AbstractEntity implements Serializable {
	/**
	 * 
	 */
	private static final long serialVersionUID = 2562015890608760010L;
	...
	public String toString() {
		return "ContactHistory [id=" + id + ", street=" + street + ", zipCode=" + zipCode + ", city=" + city
				+ ", state=" + state + ", email=" + email + ", phone=" + phone + ", country=" + country
				+ ", countryCode=" + countryCode + ", district=" + district + "]";
	}
