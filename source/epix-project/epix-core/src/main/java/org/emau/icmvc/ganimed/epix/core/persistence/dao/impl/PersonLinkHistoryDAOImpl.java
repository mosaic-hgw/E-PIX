...
public class PersonLinkHistoryDAOImpl extends PersonLinkHistoryDAO {

	@Override
	public boolean addPersonLinkHistory(PersonLinkHistory personLinkHistory)
			throws MPIException {
		try {
			personLinkHistory.setTimestamp(new Timestamp(System.currentTimeMillis()));
			em.persist(personLinkHistory);
			return true;
