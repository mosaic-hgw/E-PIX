package org.emau.icmvc.ganimed.epix.core.notifier.impl;
...
public class LogNotifier extends AbstractNotifier {
	...
	protected void notify(Notification notification) throws NotifactionException {
				
		@SuppressWarnings("deprecation")
		Priority priority = Priority.toPriority(notification.getPriority().ordinal()*10000);
		
		Object data = notification.getData();
		if (data != null && data instanceof Throwable) { 			
			logger.log(priority, notification.getMessage(), (Throwable)data);
		}  else {
			logger.log(priority, notification.getMessage());
		}
	}
