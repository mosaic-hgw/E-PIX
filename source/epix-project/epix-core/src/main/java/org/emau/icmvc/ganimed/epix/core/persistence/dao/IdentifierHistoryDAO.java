 ...
 * @since 04.11.2010
 */
public abstract class IdentifierHistoryDAO extends GenericDAO {

	/**
	 * @param sf
	 */
	public IdentifierHistoryDAO() {}
	
	public abstract IdentifierHistory addIdentifierHistory(IdentifierHistory identifierHistory, IdentifierDomain domain) throws MPIException;
