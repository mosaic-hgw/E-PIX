 ...
 * @since 04.11.2010
 */
public abstract class ContactHistoryDAO extends GenericDAO {

	public ContactHistoryDAO() {}
	
	public abstract ContactHistory addContactHistory(ContactHistory contactHistory) throws MPIException; 
