...
Zusätzlich braucht nur der Wert der ENV-Variable `EPIX_AUTH_MODE` auf *keycloak-json* gesetzt werden und der WildFly bezieht die KeyCloak-Credentials aus der JSON-Datei.
