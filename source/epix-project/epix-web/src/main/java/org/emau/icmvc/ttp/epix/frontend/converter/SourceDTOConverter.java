...
@ManagedBean
@RequestScoped
public class SourceDTOConverter extends AbstractEpixServiceBean implements Converter
{
	@Override
	public String getAsString(FacesContext context, UIComponent component, Object modelValue)
	{
		...
		{
			throw new ConverterException(new FacesMessage(text.sanitize(modelValue + " is not a valid SourceDTO")));
		}
	}
