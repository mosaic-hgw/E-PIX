...
public class Matching
{
	...
	public Matching(MatchingDTO matchingConfig)
	{
		...
		numberOfThreads = matchingConfig.getNumberOfThreads();
	...
	public MatchingDTO toDTO()
	{
		...
		return new MatchingDTO(thresholdPossibleMatch, thresholdAutomaticMatch, useCEMFIM, parallelMatchingAfter, numberOfThreads, fieldDTOs);
	}
