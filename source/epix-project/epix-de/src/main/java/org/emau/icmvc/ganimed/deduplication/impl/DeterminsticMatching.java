 ...
 * @param <T>
 */
public class DeterminsticMatching<T> extends DeduplicationStrategy<T> {
	
	public DeterminsticMatching() {
	...
	@Override
	protected MatchResult<T> decide(MatchResult<T> mr, T candidate) throws DeduplicationException {
		throw new UnsupportedOperationException();
	}

	@Override
	protected MatchResult<T> decide(MatchResult<T> mr, double probability,
			String toMatchValue, String candidateValue, ObjectField objectField)
