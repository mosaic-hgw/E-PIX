...
public class DeterministicStringBlockingAlgorithm<T> implements BlockingMatchingAlgorithm<T> {

	protected static final Logger logger = Logger.getLogger(DeterministicStringBlockingAlgorithm.class);

	@Override
	public float block(String toBlock, String candidate) throws DeduplicationException {
		boolean bool = (toBlock == null && candidate == null) || (toBlock != null && toBlock.equals(candidate));
