package org.emau.icmvc.ganimed.exception;
...
/**
 * 
 * @author Dirk Langner, Christian Schack
 * @since 2012
 *
 */
public class DeduplicationException extends Exception {

	private static final long serialVersionUID = 633157272005029081L;
	...
	public DeduplicationException(Throwable cause) {
		super(cause);
	}
}
